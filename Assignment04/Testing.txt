...
#include "sequence.h"
using namespace CS3358_SP18_A04;
using namespace std;
...
// Pre: (none)
// P	ost: The items of src are printed to cout (one per line).
int get_object_num();
// Pre:  (none)
...
{
   CS3358_SP18_A04::sequence<double> s1;  // A sequence of double for testing
   CS3358_SP18_A04::sequence<char> s2; // A sequence of char for testing
